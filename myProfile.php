...
<div id="top">
  <table border="0" align="center" cellpadding="0" cellspacing="15" id="topMenu">
    <tr>
      <td align="center"><a href="index.php">HOME</a> | <a href="profile.php">PROFILE</a> | <a href="settings.php">MY ACCOUNT</a> | <a href="logout.php">LOGOUT</a></td>
    </tr>
  </table>
</div>
<div>
...
<div>
  <form id="form1" method="post" action="">
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="10" id="cards">
      <tbody>
        <tr>
          <td height="0"><strong style="font-size: 16px">WHAT IS IN YOUR MIND? </strong></td>
        </tr>
        <tr>
          <td height="0"><textarea name="post_text" id="post_text"></textarea></td>
        </tr>
        <tr>
